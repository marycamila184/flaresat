...
def make_request(token, item):
        ...
        if len(list_results) > 0:
            ...
            results["vulcan_name"] = item.name
            results["vulcan_latitude"] = item.lat
            results["vulcan_longitude"] = item.lon
...
path_csv = "/home/marycamila/flaresat/source/volcanoes/points_volcanoes.csv"
...
df_images.to_csv("/home/marycamila/flaresat/source/volcanoes/scenes_points_volcanoes.csv",index=False)
